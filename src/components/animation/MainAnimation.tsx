                ...
                <div className="talk-wrap-bg">
                    <div className="talk-wrap" style={{ width: size.width}}>
                        ...
                        <div className="talk-img3">
                            ...
                            {isVisible && <TypingAnimation fullText="우와, 저기 나비가!" emoji="🦋" initialDelay={11500} />}
                            {!isVisible && <TypingAnimation fullText="앗, 편지가 어디갔지?" emoji="🦉💦" initialDelay={1000} />}
                        </div>
                        ...
                        {isVisible ?
                            ...
                            <div className="letter-img letter-circle disappear" >
                                <Image src="/image/letter.png" width={130} height={130} alt="편지" className="fade-out"/>
                            </div>
                        }
                        <div className="owl-img">
                            {isVisible ?  <Image src="/image/owl.png" width={300} height={300} alt=""/> :  <Image src="/image/cry-owl.png" width={300} height={300} alt=""/>}
                            <Image src="/image/left-eye.png" className="eye left-eye" width={26} height={33} alt="왼쪽눈"/>
                            <Image src="/image/right-eye.png" className="eye right-eye" width={25} height={30} alt="오른쪽눈"/>
                        </div>
                        {isVisible ? null : <ScrollingText/>}
                        {isVisible ? <ButterflyAnimation onButtonClick={switchView}/> : null}
                    </div>
                </div>
            </div>            
        )
